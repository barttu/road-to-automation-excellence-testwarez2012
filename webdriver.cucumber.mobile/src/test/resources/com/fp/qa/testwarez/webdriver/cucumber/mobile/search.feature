...
@web @mobile
Scenario Outline: As a user I want to places matching my choice
...
Scenario Outline: As a user I want to look for stops nearby a location of my choice
	Given I navigated to the home page
	And I searched for <place> from the home page
	And the following list of matched places has been returned
	| name				| postcode			|
	| <first-place>		| <first-postcode>	|
	| <second-place>	| <second-postcode>	|
	| <third-place>		| <third-postcode>	|
	| <fourth-place>	| <fourth-postcode>	|
	When I select the following place from the list
	| name 				| postcode 				|
	| <selected-place>	| <selected-postcode>	|
	Then the following list of nearby stops is returned
	| stopname			| stopcode			| towards			| routes			|
	| <first-stopname>	| <first-stopcode>	| <first-towards>	| <first-routes>	|
	| <second-stopname>	| <second-stopcode>	| <second-towards>	| <second-routes>	|
