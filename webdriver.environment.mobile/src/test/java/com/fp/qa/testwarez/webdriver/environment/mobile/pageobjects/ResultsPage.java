package com.fp.qa.testwarez.webdriver.environment.mobile.pageobjects;
...
import com.fp.qa.testwarez.webdriver.environment.mobile.common.AjaxWait;
...
public class ResultsPage extends LoadableComponent<ResultsPage> {
	...
	private static final String RESULTPAGE_PARTIAL_URL = "http://m.countdown.tfl.gov.uk/search?searchTerm=";
	...
	public List<Place> getPlaces() {
		...
		for (WebElement place : places) {
			WebElement anchor = place.findElement(By.tagName(ANCHOR_TAG));
			matchedPlaces.add(new Place(anchor.getText()));
		}
