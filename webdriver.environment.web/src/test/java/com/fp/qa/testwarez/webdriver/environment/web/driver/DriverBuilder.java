package com.fp.qa.testwarez.webdriver.environment.web.driver;
...
public class DriverBuilder {
	 ...
	 */
	private WebDriver buildRemote(DesiredCapabilities capabilities, String hub) throws MalformedURLException {
	...
	public WebDriver build(DesiredCapabilities capabilities, String hub,
			boolean startFullscreen) throws MalformedURLException {
